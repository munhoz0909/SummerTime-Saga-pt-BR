...
screen park_bushes_bag():
    ...
    if not player.has_item("treasure_key"):
        imagebutton:
            ...
            action Function(player.get_item, "treasure_key"), Show('popup', None, "boxes/popup_item_key1.png")
    ...
    if player.has_picked_up_item("treasure_key"):
        imagebutton:
            ...
            idle "boxes/auto_option_generic_01.png"
            hover HoverImage("boxes/auto_option_generic_01.png")
            action Hide("park_bushes_bag"), If(player.has_item("treasure_key"), [Function(player.get_item, "stolen_goods"), Show('popup', None, "boxes/popup_item_goods.png")], NullAction()), Jump("park_bushes_dialogue")
