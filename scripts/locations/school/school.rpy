label school_mia_study_reminder:
    ...
    show player 4
    with dissolve
    player_name "( Hmm, agora que eu aprendir um pouco de francês, {b}Eu posso ajudar Mia com seus estudos{/b}. )"
    show player 1
        ...
        if M_roxxy.is_state(S_roxxy_shower_event) and not game.timer.is_dark():
            ...
            menu:
                "Não.":
                    ...
                    player_name "Não, isso é vida ou morte ... eu deveria realmente preparar mais."
                    $ player.go_to(L_map)
                    $ game.main()
                "Sim.":

                    show player 12 with dissolve
                    player_name "Não isso tem que acabar chega de correr..."
                    player_name "É hora de colocar {b}Dexter{/b} na linha para sempre!"
