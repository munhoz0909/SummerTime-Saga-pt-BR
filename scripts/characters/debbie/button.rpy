label mom_button_dialogue:
    ...
    if M_mom.is_set("fetch lotion") and not M_mom.is_set("retrieved lotion"):
        ...
        menu debbie_dialogue_options:
            ...
            "Passar loção." if M_mom.is_set("lotion fun"):
            ...
            "Chuveiro." if M_mom.is_set("sex available"):
            ...
            "Sexo no seu quarto." if M_mom.is_set("sex available"):
                if player.location == L_home_basement:
            ...
            "Se beijar" if M_mom.is_state(S_mom_kissing_practice) and player.location == L_home_kitchen:
            ...
            "Praticar beijo" if M_mom.is_set("practice kissing") and player.location == L_home_kitchen:
